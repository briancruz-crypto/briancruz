...
def perform_reaction_fast():
    ...
    print(f"""     {white}CHOOSE TYPE OF REACTORS: 
     ...
     {red}[0]  {red} EXIT 
    ---------------------------------------------------------------------\033[0m""")  # Display only the filename
...
def logo():
    rp(pan(f"""{white}☠️ M O D I F I E D ＢＹ > {red}BRIAN {blue}
    ...
    ██      ██   ██ ██      ██      ██   ██ ██    ██    ██    
    ██      ██   ██  ██████ ███████ ██████   ██████     ██  {red} RPW {white}""",
           title=f"{Y}COOKIE GETTER", subtitle=f"{R}DEVELOP BY GabX9", border_style="bold purple"))
...
def axl1():
    ...
    print(f"     \033[31m[04] \033[32mRPW EXTRACT PAGES")
    print(f"{white}---------------------------------------------------------------------")
    save_choice = input(f"[≠] CHOICE: ").strip()
...
{white}[{red}≠{white}] {white}FRA ACCOUNT{yellow} : {green}{total_accounts}
{white}[{red}≠{white}] {white}FRA PAGES  {yellow} : {green}{total_pages}
{white}[{red}≠{white}] {white}RPW ACCOUNT{yellow} : {green}{ rpw_accounts}
{white}[{red}≠{white}] {white}RPW PAGES  {yellow} : {green}{rpw_pages}
{white}----------------------------------------------------------------------""")
    print(f"{white}[{red}01{white}] {white}EXTRACT ACCOUNT")
    print(f"{white}[{red}02{white}] {white}AUTO SHARE ")
    print(f"---------------------------------------------------------------------\033[0m")
    choice = input(f'{white}[{red}≠{white}] {white}Enter Choice: ')
...
def extraction():
    ...
    clear_screen()
    jovan()
    print(f"{white}[{red}01{white}] {white}EXTRACT {red}ACCOUNT")
    print(f"{white}[{red}02{white}] {white}EXTRACT {red}PAGES")
    print("----------------------------------------------------------------------\033[0m")
...
def main():
 ...
 {white}[{red}≠{white}] FRA ACCOUNT{yellow} : {green}{total_accounts}
 {white}[{red}≠{white}] FRA PAGES  {yellow} : {green}{total_pages}
 {white}[{red}≠{white}] RPW ACCOUNT{yellow} : {green}12,455
 ...
 {yellow}---------------------------------------------------------------------\033[0m""")
    ...
    print(f"{white}[{red}15{white}] {white}AUTO REACT {red}LIVE           {yellow}- {blue}[PAGE & ACCOUNT]")
    print(f"{white}[{red}16{white}] {white}AUTO COMMENT {red}LIVE         {yellow}- {blue}[PAGE & ACCOUNT]")
    ...
    print(f"{white}[{red}23{white}] {white}VALIDATE TOKENS         {yellow}- {green}[ACCURATE]")
    print(f"{white}[{red}24{white}] {white}REEDEM ACCOUNTS         {yellow}- {green}[ACCURATE]")
